...
function updateResultList(data) {
  if (data.hits && data.hits.length > 0) {
    ...
    for (var i = 0; i < data.hits.length; i++) {
      ...
      resultList.append('<div class="recipe"><li style="list-style-type: none;"><div class="title"><a href="'+ url +'"><h1>' + title + '</h1></div><div class="pic"><a href="'+ url +'"><img class="title_image" src="'+ image +'"></a></div><div class="ingredients"><h3>Ingredients:</h3><ul>');
      ...
      resultList.append('</ul></div></li></div>');
     }
   }
 }
