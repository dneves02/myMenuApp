...
function updateResultList(data) {
  if (data.hits && data.hits.length > 0) {
    ...
    for (var i = 0; i < data.hits.length; i++) {
      ...
      resultList.append('<div class="recipe"><li class="recipe_item" style="list-style-type: none;"><div class="title"><a href="'+ url +'"><h1>' + title + '</h1></div><div class="pic"><a href="'+ url +'"><img class="title_image" src="'+ image +'"></a></div><div class="ing_title"><h3>Ingredients:</h3></div><ul>');
